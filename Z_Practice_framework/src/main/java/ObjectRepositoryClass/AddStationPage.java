...
public class AddStationPage extends WebDriver_UtilityClass {
	...
	public void addStationmethod(String Name, WebDriver driver, String Company, String Address, String PostalCode,
			String latitude, String longitude, String MaxPower) throws InterruptedException {
		Thread.sleep(2000);
		nametextfield.sendKeys(Name + jlib.getRandomNumber());
	...
	@FindBy(xpath = "//input[@id='search_filter']")
